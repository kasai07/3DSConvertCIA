...
#include "tga.h"
#include "draw.h"
u32 icone_Large(u32 index, bool topscreen, bool botscreen, u32 topX, u32 topY, u32 botX, u32 botY)
{
	u8 tab2[6912];
	u8 tab3[6912];
	u8 icone[4608];
	...
	for(int t = 0; t < 48*48; t++)
	{
		...
		{	 
			...
			for(int j = 0; j < 48; j++)	
			{
				...
				if(topscreen == true)
				{
					SET_PIXEL(TOP_SCREEN0, (topX+j), (topY+i), RGBCOLOR(r,g,b));
				}
				if(botscreen == true)
				{
					SET_PIXEL(BOT_SCREEN0, (botX+j), (botY+i), RGBCOLOR(r,g,b));
				}
			}			
		}
	
}
u32 icone_Small(u32 index, bool topscreen, bool botscreen, u32 topX, u32 topY, u32 botX, u32 botY)
{
	u8 tab2[6912];
	u8 tab3[6912];
	u8 icone[4608];
...
u32 icone_smdh(u32 index, bool topscreen24, bool botscreen24, bool icone24, u32 topX24, u32 topY24, u32 botX24, u32 botY24, bool topscreen48, bool botscreen48, bool icone48, u32 botX48, u32 botY48, u32 topX48, u32 topY48)
{
	u8 tab2[6912];
	u8 tab3[6912];
	u8 icone[4608];
	...
	if(icone24 == true)
	{
		...
		{	 
			...
			for(int j = 0; j < 24; j++)	
			{
				...
				if(topscreen24 == true)
				{
					SET_PIXEL(TOP_SCREEN0, (topX24+j), (topY24+i), RGBCOLOR(r,g,b));
				}
				if(botscreen24 == true)
				{
					SET_PIXEL(BOT_SCREEN0, (botX24+j), (botY24+i), RGBCOLOR(r,g,b));
				}
			}			
		}
	}
	if(icone48 == true)
	{
		...
		{	 
			...
			for(int j = 0; j < 48; j++)	
			{
				...
				if(topscreen48 == true)
				{
					SET_PIXEL(TOP_SCREEN0, (topX48+j), (topY48+i), RGBCOLOR(r,g,b));
				}
				if(botscreen48 == true)
				{
					SET_PIXEL(BOT_SCREEN0, (botX48+j), (botY48+i), RGBCOLOR(r,g,b));
				}
			}			
		}
	}
